...
$navbar='#'.$warna['warna_navbar'];
$footer='#'.$warna['warna_footer'];
?>
<?php 
// $modelLay=Layout::find()->where(['id_layout' => 1])->all();
// $warna_navbar='#'.$modelLay->warna_navbar;
// $warna_footer='#'.$modelLay->warna_footer;
?>
<?php
 $model = Runtext::find()
// ->where(['id_run' => 1])
...
<div class="wrap">
    ...
    NavBar::begin([
        ...
        'options' => [
            ...
            //warna layout navbar
			'style' => 'background-color:'.$navbar.';border-color:#af0e02;',
			//warna layout navbar
			'role' => 'navigation',
        ],
    ]);
	...
	<div class="footerx" style="background:#af0e02;color:#fff;margin-bottom:-5%;">
		<div class="containerx" style="padding:10px 10px 5px 10px;">
			<br><br>
			<!-- Start Corousel -->
			 <div id="myCarousel" class="carousel slide col-md-12" data-ride="carousel" style="margin:0px;" data-interval="4000">
				<!-- Wrapper for slides -->
				<div class="carousel-inner">
					...
					<?php 			
						...
						foreach($model as $model){
							if($no==1)
							{
								echo '<div class="item active"><small>'.$model->text.'</small></div>';
							}else{
								echo '<div class="item"><small>'.$model->text.'</small></div>';
							}
							$no++;
						}
					?>
...
<footer class="footer" style="background:<?= $footer ?>;color:#fff;">
    <div class="container">
