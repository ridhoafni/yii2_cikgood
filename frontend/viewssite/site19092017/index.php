...
// $warna='#af0e02';
// $warna=Layout::model()->findAll;
// $warna=Yii::$app->session->get('id');
// $warna=Layout::model()->findByPk($id);


?>
<!-- Start Slider-->
<?php foreach($warna as $warna);?>
<div style="margin:-15% -9.2% 3% -9.2%;background-color:<?= $warna->warna ?>;min-height:810px;" class="hidden-xs">
	<!-- Start Corousel -->
	 <div id="myCarousel" class="carousel slide col-md-12" data-ride="carousel" style="margin:0px;">
		...
		<div class="carousel-inner">
		  ...
		  <div class="item">
			<img src="<?= Yii::$app->homeUrl ?>images/bw.png" alt="Chicago" style="width:100%;">
		  </div>
		
		  <div class="item">
			<img src="<?= Yii::$app->homeUrl ?>images/hw.png" alt="New york" style="width:100%;">
		  </div>
		</div>
...
<!-- Start Slider Mobile -->
<div style="margin:-16% -4.5% 3% -9.2%;background-color:<?= $warna->warna ?>;min-height:510px;" class="hidden-md hidden-lg">
	<!-- Start Corousel -->
	 <div id="myCarousel" class="carousel slide col-md-12" data-ride="carousel" style="margin:0px;">
		<!-- Indicators -->
		<ol class="carousel-indicators">
		...
		<div class="carousel-inner">
		  ...
		  <div class="item active">
			<img src="<?= Yii::$app->homeUrl ?>images/fs-mobile.png" alt="img" style="width:100%;">
		  </div>

		  <div class="item">
			<img src="<?= Yii::$app->homeUrl ?>images/bw-mobile.png" alt="img" style="width:100%;">
		  </div>
		
		  <div class="item">
			<img src="<?= Yii::$app->homeUrl ?>images/hw-mobile.png" alt="img" style="width:100%;">
		  </div>
		</div>
	...
	<div class="row"  id="layanan">
		<div class="col-lg-12 col-md-12">
			<div class="col-md-4 panel panel-danger" align="center"  style="margin:0%; padding:0%;">
				...
				<div class="panel-heading" style="height:210px;background:<?= $warna->warna?>;color:#ffffff;">
