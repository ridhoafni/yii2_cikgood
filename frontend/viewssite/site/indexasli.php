...
<div style="margin:-15% -9.2% 3% -9.2%;background-color:<?= $warna->warna_slider ?>;min-height:810px;" class="hidden-xs">
	<!-- Start Corousel -->
...
<!-- Start Slider Mobile -->
<div style="margin:-16% -4.5% 3% -9.2%;background-color:<?= $warna->warna_slider ?>;min-height:510px;" class="hidden-md hidden-lg">
	<!-- Start Corousel -->
	 <div id="myCarousel" class="carousel slide col-md-12" data-ride="carousel" style="margin:0px;">
		<!-- Indicators -->
		<ol class="carousel-indicators">
	...
	<div class="row"  id="layanan">
		<div class="col-lg-12 col-md-12">
			<div class="col-md-4 panel panel-danger" align="center"  style="margin:0%; padding:0%;">
				...
				<div class="panel-heading" style="height:210px;background:<?= $warna->warna_slider?>;color:#ffffff;">
